      ...
      <div className="container">
        <Row className="tc-img-wrapper">
          <Col span={24}>
            <div className="position-relative w-100 h-100">
              <img
                className="w-100 h-100 candidate-banner-img"
                src={TopCandidateImg}
                alt="Top Candidate"
              />
              ...
              <div className="top-candidate-section__progress-container">
                <div className="progressWrapper">
                  ...
                  <div className="progressPercentage-wrapper">
                    <p className="pText subtitle-1 text-white">
                      Overall Percentage
                    </p>
        ...
        <div className="top-candidate-desc flex-all-center w-100 mt-80">
          <p className="h6r text-center">
            Ensure every new colleague you hire fits in right away by measuring
            their human aptitude before you make a job offer. You can’t afford
            to dilute your talent pool.
          </p>
        </div>
